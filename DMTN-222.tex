...
As part of the switch to TAXICAB approval of new calibrations, we have a tracking page at \url{https://rubinobs.atlassian.net/wiki/spaces/DM/pages/281673762/TAXICAB+Tracking+Page}.
...
We have a number of auxilliary instruments that generate ``calibration-like'' data products that are useful to provide independent measurements to support the activities of the main cameras.
...
This transfer mode is enforced by the task's config validation step, to prevent unreadable files from being ingested.
...
Ingestion can be performed with a command like:
\begin{verbatim}
butler ingest-photodiode /repo/main lsst.obs.lsst.LsstCam s3://lfa@rubinobs-lfa-cp/Electrometer:103/fits/2025/06/07/ --transfer=copy
\end{verbatim}
...
\begin{tabular}{l|l|l|l}
  \label{tab:electrometers}
    Electrometer Name & Location & Model & Purpose \\
    \hline
